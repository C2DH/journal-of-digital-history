...
const CookiesPlaceholder = ({
  ...
  return (
      <div style={{ height }} className={styles.CookiesPlaceholder}>
          ...
          <p>By clicking <a onClick={setAcceptThirdPartyCookies}>here</a>, you consent to the use of third-party cookies on the entire website and this content will be displayed.</p>
      </div>
  )
}
